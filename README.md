![image](https://i.imgur.com/PxvbIBm.png)
### Project Sloth UI
...
```
exports['psr-ui']:Circle(function(success)
    if success then
        print("success")
	else
		print("fail")
...
## Number Maze
```
exports['psr-ui']:Maze(function(success)
    if success then
        print("success")
	else
		print("fail")
...
## VAR
```
exports['psr-ui']:VarHack(function(success)
    if success then
        print("success")
	else
		print("fail")
 ...
 ## Thermite
 ```
exports['psr-ui']:Thermite(function(success)
    if success then
        print("success")
	else
		print("fail")
...
## Display Text
```
exports['psr-ui']:DisplayText("Example Text", "primary") -- Colors: primary, error, success, warning, info, mint
exports['psr-ui']:HideText()
```
![image](https://user-images.githubusercontent.com/7463741/170587380-0629b5fc-80d6-4c2a-85c1-4e5426167197.png)

## Status UI
```
exports['psr-ui']:StatusShow("Area Dominance", {
  "Gang: Ballas",
  "Influence: %100",
})
exports['psr-ui']:StatusUpdate("Area Dominance", {
  "Gang: Ballas",
  "Influence: %99",
})
exports['psr-ui']:StatusHide()
```
![image](https://user-images.githubusercontent.com/7463741/170587637-57217095-29ab-460e-9933-123fb0500e12.png)

## Menus
```
exports['psr-ui']:CreateMenu({
        {
            header = "header1",
            text = "text1",
...
```
local input = exports['psr-ui']:Input({
        title = "Test",
        inputs = {
            {
                type = "text",
...
```
exports['psr-ui']:ShowImage("https://user-images.githubusercontent.com/91661118/168956591-43462c40-e7c2-41af-8282-b2d9b6716771.png")
```
